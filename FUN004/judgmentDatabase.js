...
const JUDGMENT_CASES = [
  {
    ...
    status: "심사 완료",
    reviews: [
      { dept:"안유", reviewer:"김철수", request:"2024-01-05", start:"2024-01-07", end:"2024-01-20", status:"완료", 
        opinion:"제출된 품질관리 자료가 기준에 적합하며, 제조공정이 GMP 기준을 충족함을 확인했습니다.", 
        documents:["품질관리계획서.pdf", "제조공정도.pdf", "시험성적서.pdf"] },
      { dept:"안유", reviewer:"김은우", request:"2024-01-10", start:"2024-01-11", end:"2024-01-22", status:"완료", 
      ...
      { dept:"안유", reviewer:"홍길동", request:"2024-01-05", start:"2024-01-06", end:"2024-01-15", status:"완료", 
        opinion:"동물실험 자료가 충분하며, 안전성 평가 기준을 만족합니다.", 
        documents:["동물실험계획서.pdf", "실험결과보고서.pdf", "안전성평가서.pdf"] },
      ...
      { dept:"RMP", reviewer:"이영희", request:"2024-01-08", start:"2024-01-09", end:"2024-01-12", status:"완료", 
        opinion:"위험관리계획이 체계적으로 수립되어 있으며, 부작용 모니터링 방안이 적절합니다.", 
        documents:["위험관리계획서.pdf", "부작용모니터링계획.pdf"] },
      { dept:"RMP", reviewer:"이영희", request:"2024-01-14", start:"2024-01-15", end:"2024-01-18", status:"완료", 
        opinion:"추가 제출된 위험관리 자료를 검토한 결과, 보완사항이 모두 해결되었습니다.", 
        documents:["위험관리계획서_보완.pdf", "부작용사례보고서.pdf"] },
      { dept:"안유", reviewer:"이영희", request:"2024-01-19", start:"2024-01-19", end:"2024-01-20", status:"완료", 
        opinion:"최종 품질관리 검토 완료. 모든 기준을 충족합니다.", 
        documents:["최종품질관리보고서.pdf"] },
      { dept:"GMP", reviewer:"박민수", request:"2024-01-05", start:"2024-01-06", end:"2024-01-12", status:"완료", 
        opinion:"제조시설이 GMP 기준을 충족하며, 품질관리체계가 적절히 구축되어 있습니다.", 
        documents:["GMP인증서.pdf", "제조시설도면.pdf", "품질관리체계도.pdf"] },
      { dept:"GMP", reviewer:"박민수", request:"2024-01-14", start:"2024-01-15", end:"2024-01-25", status:"완료", 
        opinion:"보완 요청사항이 모두 해결되었으며, 최종 GMP 심사 통과를 확인했습니다.", 
        documents:["GMP보완사항해결보고서.pdf", "최종GMP심사보고서.pdf"] }
    ]
  },
  {
    id: "2024000213",
    ...
    reviews: [
      { dept:"안유", reviewer:"오지은", request:"2025-02-13", start:"2025-02-14", end:"2025-03-02", status:"완료", 
        opinion:"동물실험 결과가 양호하며, 안전성 프로파일이 확인되었습니다.", 
        documents:["동물실험보고서.pdf", "안전성프로파일.pdf"] },
      { dept:"안유", reviewer:"오지은", request:"2025-03-05", start:"2025-03-06", end:"", status:"진행", 
        opinion:"추가 안전성 자료 검토 중입니다.", 
        documents:["추가안전성자료.pdf"] },
      { dept:"안유", reviewer:"정해준", request:"2025-02-13", start:"", end:"", status:"대기", 
        opinion:"", 
        documents:[] },
      { dept:"GCP", reviewer:"최수진", request:"2025-03-01", start:"2025-03-02", end:"2025-03-12", status:"완료", 
        opinion:"임상시험 설계가 적절하며, 통계적 분석 계획이 충분합니다.", 
        documents:["임상시험계획서.pdf", "통계분석계획서.pdf", "연구자매뉴얼.pdf"] },
      { dept:"안유", reviewer:"최수진", request:"2025-03-14", start:"2025-03-15", end:"2025-03-18", status:"완료", 
        opinion:"최종 안전성 검토 완료. 승인 가능합니다.", 
        documents:["최종안전성보고서.pdf"] },
      { dept:"GMP", reviewer:"문성현", request:"2025-02-13", start:"2025-02-16", end:"2025-03-10", status:"완료", 
        opinion:"제조시설 점검 결과 GMP 기준을 충족하며, 품질관리체계가 적절합니다.", 
        documents:["GMP점검보고서.pdf", "제조시설평가서.pdf", "품질관리체계평가서.pdf"] }
    ]
  },
  {
    id: "2025000301",
